  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?=base_url('masyarakat/kategori')?>">
          <i class="fas fa-fw fa-palette"></i>
          <span>Kategori</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?=base_url('masyarakat/masyarakat')?>">
          <i class="fas fa-fw fa-palette"></i>
          <span>Masyarakat</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?=base_url('masyarakat/petugas')?>">
          <i class="fas fa-fw fa-palette"></i>
          <span>Petugas</span>
        </a>
      </li>
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12 text-center">
                  <i class="fab fa-fw fa-github"></i>&nbsp;nganu</a></p>
            </div>
          </div>
