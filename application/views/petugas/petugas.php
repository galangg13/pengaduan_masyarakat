        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <img class="img-profile rounded-circle" src="<?= base_url('assets/assets/img/logo p.png') ?>" style="max-width: 60px">
                ...
                <table class="table table-striped table-bordered zero-configuration">
                  ...
                  <?php foreach ($petugas as $p) : ?>
                    <tr>
                      ...
                      <td><?= $p['telp'] ?></td>
                      <td>
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modaledit<?php echo $p['id']; ?>">
                          Edit</button>
                        <a class="btn btn-danger" href="<?= base_url('admin/delete_petugas/' . $p['id']) ?>" onclick="return confirm('Apakah Anda Yakin?');">Delete</a>
                      </td>
                    </tr>
                    <!-- edit modal -->
                    <div class="modal fade" id="modaledit<?php echo $p['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="<?php echo base_url('admin/edit_petugas/') . $p['id'] ?>" method="post">
                              <div class="row">
