                                    ...
                                    <div class="login-form">
                                        ...
                                        <form class="user" method="POST" action="<?= base_url('Auth/admin_registration'); ?>">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-user" id="nik" name="nik" placeholder="nik" value="<?= set_value('nik'); ?>"><?= form_error('nik', '<small class="text-danger pl-3">', '</small>'); ?>
                                            </div>
                                            <br>
                                            <div class="form-group row">
                                                <div class="col-sm-12 mb-3 mb-sm-0">
                                                    <input type="text" class="form-control form-control-user" name="nama" id="nama" placeholder="nama" value="<?= set_value('nama'); ?>"><?= form_error('nama', '<small class="text-danger pl-3">', '</small>'); ?>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                            ...
                                            <br>
                                            <div class="form-group">
                                                <input type="number" class="form-control form-control-user" id="telepon" name="telepon" placeholder="telp" value="<?= set_value('telepon'); ?>"><?= form_error('telepon', '<small class="text-danger pl-3">', '</small>'); ?>
                                            </div>
                                            <br>
                                            ...
                                            <div class="text-center">
                                                <a class="font-weight-bold small" href="<?= base_url('auth/login_petugas') ?>">Tekan
